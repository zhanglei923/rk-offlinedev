let showInfomation = (result)=>{
    ...
    <thead style="background-color: #eaeaea;">
        <tr>
            <th align="left" colspan="999">INFOMATION</th>
        </tr>
    </thead>
    <tbody>
        <tr><td>分支：</td><td>${result.branchName}</td></tr>
        <tr><td>目录：</td><td class="${result.isCustomizedWebRoot?'user-config':''}">${result.webpath}&nbsp;${result.isCustomizedWebRoot?'(自定义)':''}</td></tr>
