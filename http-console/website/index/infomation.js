let showInfomation = (result)=>{
    ...
    <tbody>
        ...
        <tr><td align="right" valign="top">配置：</td><td>
            <span title="user-config.json: debug.mode" class="${userConfig.debug && userConfig.debug.mode?'status_is_on status_is_warn':'status_is_off status_is_neutral'}">"${userConfig.debug.mode}"</span>
