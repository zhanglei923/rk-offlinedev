let showInfomation = (result)=>{
    ...
    <tbody>
        ...
        <tr><td align="right" valign="top">子工程检测：</td><td><table><tbody><tr><td><div id="subproject_verify" class="subproject_verify"><span class="status_negative">Loading...</span></div></td></tr></tbody></table></td></tr>
