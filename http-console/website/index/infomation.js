let showInfomation = (result)=>{
    ...
    <tbody>
        ...
        <tr><td align="right" valign="top">工具配置：</td><td>
            ...
            <span><span title="user-config.json: debug.concatStaticTplRequests" class="${userConfig.debug && userConfig.debug.concatStaticTplRequests?'status_is_on status_is_positive':'status_is_off status_is_negative'}">CBN-TPL</span>
            <span><span title="user-config.json: debug.concatStaticJsRequests" class="${userConfig.debug && userConfig.debug.concatStaticJsRequests?'status_is_on status_is_dangous':'status_is_off status_is_neutral'}">CBN-JS</span>
