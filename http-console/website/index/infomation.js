let showInfomation = (result)=>{
    ...
    <tbody>
        ...
        <tr><td align="right" valign="top">配置：</td><td>
            ...
            <span title="user-config.json: debug.autoCacheStaticRequests" class="${userConfig.debug && userConfig.debug.autoCacheStaticRequests?'status_is_on status_is_positive':'status_is_off status_is_negative'}">Cache L1</span>
            <span title="user-config.json: debug.autoCacheStaticRequestsLevel2" class="${userConfig.debug && userConfig.debug.autoCacheStaticRequestsLevel2?'status_is_on status_is_positive':'status_is_off status_is_negative'}">L2</span>
